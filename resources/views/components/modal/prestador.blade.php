        ...
        <div class="relative w-full max-w-4xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Cadastrar Prestador</h3>
                    <form class="space-y-6" wire:submit.prevent="create">
                        <div>
                            ...
                            @enderror
                            <label
                                class="block mb-2 mt-2 text-sm font-medium text-gray-900 dark:text-white">Empresa</label>
